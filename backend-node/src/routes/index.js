...
function setupRouter(cfg, db, log) {
  ...
  // ---------- AI production workbench (dry-run by default) ----------
  r.get('/agent/providers/status', agent.providers);
  r.post('/agent/plan', agent.plan);
  ...
  r.post('/agent/runs/:id/retry', agent.control('retry'));
  r.get('/approvals', agent.listApprovals);
  r.post('/approvals/:id/approve', agent.resolveApproval('approve'));
  r.post('/approvals/:id/reject', agent.resolveApproval('reject'));
  r.get('/projects/:id/costs', agent.costs);
  ...
  r.post('/episodes/:episode_id/continuity-audit', storyboards.auditContinuity);
  r.post('/episodes/:episode_id/screen-composition-audit', storyboards.auditScreenComposition);
