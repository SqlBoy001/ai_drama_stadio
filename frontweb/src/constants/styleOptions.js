...
export const SUSPENSE_MANHUA_STYLE_VALUE = 'urban suspense manhua'
export const SUSPENSE_REALISTIC_STYLE_VALUE = 'urban suspense cinematic'
...
export const generationStyleOptions = [
  {
    ...
    options: [
      ...
      { label: '写实电影·都市悬疑', value: SUSPENSE_REALISTIC_STYLE_VALUE,
        prompt:   '写实电影级都市怪谈悬疑，真人比例与自然五官，真实皮肤纹理、毛发和布料材质，克制自然的微表情与肢体语言，现代中国旧城区实景质感，低饱和青绿灰色调，病态冷白荧光灯与少量脏黄色实景光源，低调布光、高反差硬阴影与深黑暗部，窥视式偏心构图、大面积负空间、轻微荷兰角与35毫米电影镜头，轻微胶片颗粒和克制的心理恐怖张力；避免动漫线稿、二次元五官、赛璐璐上色、CG塑料皮肤、过度磨皮、网红妆容和廉价恐怖符号堆砌',
        promptEn: 'photorealistic cinematic urban folklore psychological suspense, real Chinese actors with natural human proportions and facial anatomy, authentic skin pores, hair strands and fabric materials, restrained micro-expressions and body language, grounded modern Chinese old-city locations, desaturated cyan green gray palette, sickly cold fluorescent practicals with sparse dirty amber light, low-key lighting, hard high-contrast shadows and deep blacks, voyeuristic off-center framing, large negative space, slight Dutch angles and 35mm cinematic lenses, subtle film grain and restrained psychological dread; avoid anime linework, stylized anime facial proportions, cel shading, plastic CGI skin, excessive beauty retouching, influencer makeup and generic horror clutter',
        color: 'linear-gradient(135deg,#081416,#665044)', thumb: '/style-thumbs/horror.jpg' },
    ]
  },
  {
    label: '动漫 / 卡通',
    options: [
      ...
      { label: '都市怪谈悬疑漫剧', value: SUSPENSE_MANHUA_STYLE_VALUE,
        prompt:   '写实二次元都市怪谈悬疑漫剧，半写实国漫人物与真实旧城区环境材质，低饱和青绿灰色调，病态冷白荧光灯与少量脏黄色实景光源，低调布光、高反差硬阴影与深黑暗部，潮湿墙皮、锈蚀金属、霉斑和轻微胶片颗粒，窥视式偏心构图、大面积负空间、轻微荷兰角与35毫米电影镜头，克制的心理恐怖张力；避免Q版、明亮赛璐璐、塑料质感、均匀照明、对称游戏场景展示和廉价恐怖符号堆砌',
        promptEn: 'realistic anime urban folklore suspense manhua, semi-realistic Chinese animation characters with grounded old-city environmental materials, desaturated cyan green gray palette, sickly cold fluorescent practicals with sparse dirty amber light, low-key lighting, hard high-contrast shadows and deep blacks, damp peeling walls, corroded metal, mildew and subtle film grain, voyeuristic off-center framing, large negative space, slight Dutch angles and 35mm cinematic lenses, restrained psychological suspense; avoid chibi, bright cel shading, plastic surfaces, flat even lighting, symmetrical game-environment presentation and generic horror-clutter clichés',
        color: 'linear-gradient(135deg,#071a1d,#80604c)', thumb: '/style-thumbs/horror.jpg' },
...
/** 工作台自动美术路由；用户手动选择后不再覆盖。 */
export function recommendWorkbenchStyle(genre, instruction, currentStyle = '2.5D国漫', isAuto = true) {
  if (!isAuto) return currentStyle
  const suspense = /悬疑|惊悚|恐怖|怪谈/.test(`${genre || ''} ${instruction || ''}`)
  return suspense ? SUSPENSE_REALISTIC_STYLE_VALUE : '2.5D国漫'
}
